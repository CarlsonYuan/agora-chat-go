...
func (c *Client) QueryUser(ctx context.Context, userID string) (*QueryUsersResponse, error) {
	if userID == "" {
...
func (c *Client) QueryUsers(ctx context.Context, q *QueryOption) (*QueryUsersResponse, error) {
